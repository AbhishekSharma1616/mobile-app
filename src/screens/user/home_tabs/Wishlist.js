  ...
  return (
    <View style={{ height: '92%' }}>
      ...
      <View style={styles.container}>
        ...
        <ImageSlider
          caroselImageContainerStyle={{ height: 250, width: 400, borderRadius: 20 }}
          data={banners}
          autoPlay={false}
          showIndicator={false}
          preview={false}
          ...
          <FlatList
            ...
            renderItem={({ item: offer }) => (
              <TouchableOpacity
                ...
                style={[
                  styles.offerItem,
                  { width: '45%', padding: 10, borderRadius: 12, margin: 18, marginTop: 2, alignItems: 'center', justifyContent: 'center' }
                ]}
                onPress={() => {
